...
from utils import SimpleAttention, MatchingAttention
...
class CommonsenseRNNCell(nn.Module):
    ...
    def forward(self, U, x1, x2, x3, o1, o2, qmask, g_hist, q0, r0, i0, e0):
        ...
        if self.listener_state:
            ...
            # print("Shape of input to rl_cell:", U_er_ss_.shape)
            # print("Shape of r0:", r0.shape)
            # print("Expected input size:", self.D_m + self.D_s + self.D_g)
            # print("r0.view(-1, self.D_r) shape:", r0.view(-1, self.D_r).shape)
